...
const GradientBackground: React.FC = () => {
    return (
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
            ...
            <div className="relative w-full h-full bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 dark:hidden">
            ...
            <div className="hidden dark:block relative w-full h-full bg-gradient-to-br from-slate-950 via-indigo-950/50 to-purple-950/30">
