    ...
    <div className="h-full glass-card-light dark:glass-card-dark rounded-[32px] flex flex-col overflow-hidden relative" style={{ height: '100%', maxHeight: '100%' }}>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar" style={{ minHeight: 0, maxHeight: '100%' }}>
        ...
        <div className="space-y-4 pb-4">
           <div className="flex items-center justify-between">
             <span className="text-[10px] font-bold text-gray-400 dark:text-gray-300 uppercase tracking-wider">AII Impact Analysis</span>
             <div className="bg-gray-50 dark:bg-white/5 p-1 rounded"><BarChart2 size={12} className="text-gray-400 dark:text-gray-300" /></div>
           </div>
           
           {/* Score Breakdown */}
           <div className="grid grid-cols-3 gap-2">
             <div className="bg-gray-50 dark:bg-white/5 p-3 rounded-xl text-center border border-gray-100 dark:border-white/5">
                <div className="text-[8px] text-gray-400 dark:text-gray-300 uppercase mb-1 font-bold">Volume</div>
                <div className="text-sm font-black text-gray-800 dark:text-gray-100">{Math.floor(selectedNode.scaleScore)}</div>
             </div>
             <div className="bg-gray-50 dark:bg-white/5 p-3 rounded-xl text-center border border-gray-100 dark:border-white/5">
                <div className="text-[8px] text-gray-400 dark:text-gray-300 uppercase mb-1 font-bold">Timing</div>
                <div className="text-sm font-black text-blue-600 dark:text-blue-400">{Math.floor(selectedNode.timingScore)}</div>
             </div>
             <div className="bg-gray-50 dark:bg-white/5 p-3 rounded-xl text-center border border-gray-100 dark:border-white/5">
                <div className="text-[8px] text-gray-400 dark:text-gray-300 uppercase mb-1 font-bold">Correlation</div>
